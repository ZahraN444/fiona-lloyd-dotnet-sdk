// <copyright file="FloorRequestCommonArea.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<FloorRequestCommonArea>),
        new Type[] {
    ...
    public abstract class FloorRequestCommonArea
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The FloorRequestCommonArea instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static FloorRequestCommonArea FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorRequestCommonArea instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static FloorRequestCommonArea FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorRequestCommonArea instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static FloorRequestCommonArea FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorRequestCommonArea instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static FloorRequestCommonArea FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : FloorRequestCommonArea, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : FloorRequestCommonArea, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : FloorRequestCommonArea, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : FloorRequestCommonArea, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
