// <copyright file="FloorResponseBoundary.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<FloorResponseBoundary>),
        new Type[] {
    ...
    public abstract class FloorResponseBoundary
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The FloorResponseBoundary instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static FloorResponseBoundary FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseBoundary instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static FloorResponseBoundary FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseBoundary instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static FloorResponseBoundary FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseBoundary instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static FloorResponseBoundary FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : FloorResponseBoundary, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : FloorResponseBoundary, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : FloorResponseBoundary, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : FloorResponseBoundary, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
