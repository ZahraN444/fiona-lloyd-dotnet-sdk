// <copyright file="CalendarEventCreateRequestLocation.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CalendarEventCreateRequestLocation>),
        new Type[] {
    ...
    public abstract class CalendarEventCreateRequestLocation
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The CalendarEventCreateRequestLocation instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static CalendarEventCreateRequestLocation FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventCreateRequestLocation instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static CalendarEventCreateRequestLocation FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventCreateRequestLocation instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static CalendarEventCreateRequestLocation FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventCreateRequestLocation instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static CalendarEventCreateRequestLocation FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : CalendarEventCreateRequestLocation, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : CalendarEventCreateRequestLocation, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : CalendarEventCreateRequestLocation, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : CalendarEventCreateRequestLocation, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
