// <copyright file="CameraRequestCoordinates.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CameraRequestCoordinates>),
        new Type[] {
    ...
    public abstract class CameraRequestCoordinates
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The CameraRequestCoordinates instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static CameraRequestCoordinates FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraRequestCoordinates instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static CameraRequestCoordinates FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraRequestCoordinates instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static CameraRequestCoordinates FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraRequestCoordinates instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static CameraRequestCoordinates FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : CameraRequestCoordinates, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : CameraRequestCoordinates, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : CameraRequestCoordinates, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : CameraRequestCoordinates, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
