// <copyright file="RegionFeatureResponseBoundary.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<RegionFeatureResponseBoundary>),
        new Type[] {
    ...
    public abstract class RegionFeatureResponseBoundary
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The RegionFeatureResponseBoundary instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static RegionFeatureResponseBoundary FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureResponseBoundary instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static RegionFeatureResponseBoundary FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureResponseBoundary instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static RegionFeatureResponseBoundary FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureResponseBoundary instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static RegionFeatureResponseBoundary FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : RegionFeatureResponseBoundary, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : RegionFeatureResponseBoundary, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : RegionFeatureResponseBoundary, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : RegionFeatureResponseBoundary, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
