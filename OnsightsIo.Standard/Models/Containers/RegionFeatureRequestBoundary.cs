// <copyright file="RegionFeatureRequestBoundary.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<RegionFeatureRequestBoundary>),
        new Type[] {
    ...
    public abstract class RegionFeatureRequestBoundary
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The RegionFeatureRequestBoundary instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static RegionFeatureRequestBoundary FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureRequestBoundary instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static RegionFeatureRequestBoundary FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureRequestBoundary instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static RegionFeatureRequestBoundary FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionFeatureRequestBoundary instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static RegionFeatureRequestBoundary FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : RegionFeatureRequestBoundary, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : RegionFeatureRequestBoundary, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : RegionFeatureRequestBoundary, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : RegionFeatureRequestBoundary, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
