// <copyright file="FloorResponseCommonArea.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<FloorResponseCommonArea>),
        new Type[] {
    ...
    public abstract class FloorResponseCommonArea
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The FloorResponseCommonArea instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static FloorResponseCommonArea FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseCommonArea instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static FloorResponseCommonArea FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseCommonArea instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static FloorResponseCommonArea FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The FloorResponseCommonArea instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static FloorResponseCommonArea FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : FloorResponseCommonArea, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : FloorResponseCommonArea, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : FloorResponseCommonArea, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : FloorResponseCommonArea, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
