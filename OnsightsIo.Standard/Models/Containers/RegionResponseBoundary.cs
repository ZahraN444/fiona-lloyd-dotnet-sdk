// <copyright file="RegionResponseBoundary.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<RegionResponseBoundary>),
        new Type[] {
    ...
    public abstract class RegionResponseBoundary
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The RegionResponseBoundary instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static RegionResponseBoundary FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionResponseBoundary instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static RegionResponseBoundary FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionResponseBoundary instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static RegionResponseBoundary FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The RegionResponseBoundary instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static RegionResponseBoundary FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : RegionResponseBoundary, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : RegionResponseBoundary, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : RegionResponseBoundary, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : RegionResponseBoundary, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
