// <copyright file="BuildingResponseBoundary.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<BuildingResponseBoundary>),
        new Type[] {
    ...
    public abstract class BuildingResponseBoundary
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The BuildingResponseBoundary instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static BuildingResponseBoundary FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The BuildingResponseBoundary instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static BuildingResponseBoundary FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The BuildingResponseBoundary instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static BuildingResponseBoundary FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The BuildingResponseBoundary instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static BuildingResponseBoundary FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : BuildingResponseBoundary, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : BuildingResponseBoundary, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : BuildingResponseBoundary, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : BuildingResponseBoundary, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
