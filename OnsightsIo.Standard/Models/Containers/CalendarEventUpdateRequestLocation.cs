// <copyright file="CalendarEventUpdateRequestLocation.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CalendarEventUpdateRequestLocation>),
        new Type[] {
    ...
    public abstract class CalendarEventUpdateRequestLocation
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The CalendarEventUpdateRequestLocation instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static CalendarEventUpdateRequestLocation FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventUpdateRequestLocation instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static CalendarEventUpdateRequestLocation FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventUpdateRequestLocation instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static CalendarEventUpdateRequestLocation FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventUpdateRequestLocation instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static CalendarEventUpdateRequestLocation FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : CalendarEventUpdateRequestLocation, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : CalendarEventUpdateRequestLocation, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : CalendarEventUpdateRequestLocation, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : CalendarEventUpdateRequestLocation, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
