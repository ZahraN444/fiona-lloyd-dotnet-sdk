// <copyright file="CameraResponseCoordinates.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CameraResponseCoordinates>),
        new Type[] {
    ...
    public abstract class CameraResponseCoordinates
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The CameraResponseCoordinates instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static CameraResponseCoordinates FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraResponseCoordinates instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static CameraResponseCoordinates FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraResponseCoordinates instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static CameraResponseCoordinates FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CameraResponseCoordinates instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static CameraResponseCoordinates FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : CameraResponseCoordinates, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : CameraResponseCoordinates, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : CameraResponseCoordinates, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : CameraResponseCoordinates, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
