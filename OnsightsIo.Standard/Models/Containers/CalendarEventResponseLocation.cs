// <copyright file="CalendarEventResponseLocation.cs" company="APIMatic">
...
namespace OnsightsIo.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CalendarEventResponseLocation>),
        new Type[] {
    ...
    public abstract class CalendarEventResponseLocation
    {
        /// <summary>
        /// This is LineRepresentation case.
        /// </summary>
        /// <returns>
        /// The CalendarEventResponseLocation instance, wrapping the provided LineRepresentation value.
        /// </returns>
        public static CalendarEventResponseLocation FromLineRepresentation(LineRepresentation lineRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventResponseLocation instance, wrapping the provided PointRepresentation value.
        /// </returns>
        public static CalendarEventResponseLocation FromPointRepresentation(PointRepresentation pointRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventResponseLocation instance, wrapping the provided PolygonRepresentation value.
        /// </returns>
        public static CalendarEventResponseLocation FromPolygonRepresentation(PolygonRepresentation polygonRepresentation)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CalendarEventResponseLocation instance, wrapping the provided PolylineRepresentation value.
        /// </returns>
        public static CalendarEventResponseLocation FromPolylineRepresentation(PolylineRepresentation polylineRepresentation)
        {
        ...
        private sealed class LineRepresentationCase : CalendarEventResponseLocation, ICaseValue<LineRepresentationCase, LineRepresentation>
        {
        ...
        private sealed class PointRepresentationCase : CalendarEventResponseLocation, ICaseValue<PointRepresentationCase, PointRepresentation>
        {
        ...
        private sealed class PolygonRepresentationCase : CalendarEventResponseLocation, ICaseValue<PolygonRepresentationCase, PolygonRepresentation>
        {
        ...
        private sealed class PolylineRepresentationCase : CalendarEventResponseLocation, ICaseValue<PolylineRepresentationCase, PolylineRepresentation>
        {
